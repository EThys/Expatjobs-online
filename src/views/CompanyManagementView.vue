...
const removeCompany = async (company: ICompany) => {
  if (
    !confirm(
      `${t('companyManagement.deleteConfirm')} "${(company as any).name ?? (company as any).companyName}" ?`,
    )
  ) {
    return
  }
    ...
    <div class="max-w-7xl mx-auto relative">
      ...
      <div class="relative rounded-[3rem] overflow-hidden min-h-[550px] bg-[#1e3a5f] shadow-2xl">
        ...
        <div class="absolute inset-0 z-0">
          ...
          <div
            class="absolute inset-0 bg-gradient-to-r from-[#1e3a5f] via-[#1e3a5f]/80 to-transparent"
          ></div>
          <div
            class="absolute inset-0 bg-gradient-to-t from-[#1e3a5f] via-transparent to-transparent opacity-80"
          ></div>
        </div>

        <!-- Content (Left Aligned) -->
        <div
          class="relative z-10 h-full flex flex-col justify-end p-8 md:p-16 pb-32 md:pb-24 max-w-3xl"
        >
          <div class="animate-fade-in-up">
            ...
            <p
              class="text-blue-100 text-lg md:text-xl font-medium tracking-wide max-w-xl opacity-90"
            >
        ...
        <div class="absolute bottom-0 right-0 z-20 hidden md:block">
          <div
            class="relative bg-[#f9fafb] rounded-tl-[2.5rem] pt-8 pl-8 pr-8 pb-8 flex items-center gap-4"
          >
            <!-- Inverse Corner Smoothing (Top Left of the white box) -->
            <div class="absolute -top-[40px] right-0 w-[40px] h-[40px] overflow-hidden">
              <div
                class="absolute bottom-0 right-0 w-full h-full bg-transparent rounded-br-[2.5rem] shadow-[10px_10px_0_10px_#f9fafb]"
              ></div>
            </div>
  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 -mt-32 relative z-20">
        <div
          class="bg-white rounded-2xl shadow-xl p-6 border border-blue-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
        >
          <div class="flex items-center justify-between">
            ...
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg"
            >
        ...
        <div
          class="bg-white rounded-2xl shadow-xl p-6 border border-green-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
        >
          <div class="flex items-center justify-between">
            <div>
            ...
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg"
            >
              <svg class="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  stroke-linecap="round"
        ...
        <div
          class="bg-white rounded-2xl shadow-xl p-6 border border-purple-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
        >
          <div class="flex items-center justify-between">
            <div>
            ...
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg"
            >
              <svg class="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  stroke-linecap="round"
      ...
      <!-- Main Card -->
      <div
        class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-100 overflow-hidden"
      >
        <div class="grid grid-cols-1 lg:grid-cols-3">
          <!-- Liste des entreprises -->
          <div
            class="border-b lg:border-b-0 lg:border-r border-gray-100 bg-gradient-to-br from-gray-50 to-white"
          >
            <div
              class="px-6 py-5 flex items-center justify-between border-b border-gray-200 bg-white"
            >
              <h2
                class="text-base font-bold text-[#1e3a5f] uppercase tracking-wide flex items-center"
              >
            ...
            <div class="p-5 lg:max-h-[500px] lg:overflow-y-auto custom-scrollbar">
              <div v-if="loading" class="flex flex-col items-center justify-center py-16">
                <div
                  class="animate-spin rounded-full h-12 w-12 border-4 border-blue-200 border-t-[#1e3a5f] mb-4"
                ></div>
          ...
          <div class="lg:col-span-2">
            <div
              class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-[#1e3a5f] to-[#2d4a6f]"
            >
            ...
            <div class="p-8">
              ...
              <form v-else @submit.prevent="saveCompany" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="md:col-span-2">
                    <label class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                      <svg
                        class="w-4 h-4 mr-2 text-[#1e3a5f]"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                ...
                <div
                  class="pt-6 border-t-2 border-gray-100 flex flex-col sm:flex-row gap-4 justify-end"
                >
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span>{{
                      saving ? t('companyManagement.saving') : t('companyManagement.save')
                    }}</span>
                  </button>
                </div>
              </form>
