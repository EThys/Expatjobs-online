<template>
  <div class="min-h-screen flex flex-col">
    ...
    <div
      v-if="!isLoading && !isProfileComplete && !showCreationWizard"
      class="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center px-4 py-8"
    >
      <div class="max-w-lg w-full bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden">
        <div class="p-8 text-center">
          <div
            class="w-24 h-24 mx-auto bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center mb-6"
          >
          ...
          <p class="text-gray-600 mb-8">
            Créez votre profil professionnel en quelques étapes simples pour accéder aux meilleures
    ...
    <div
      ...
      class="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center p-2 sm:p-4 pt-20 sm:pt-24 md:pt-28"
    >
      <div class="w-full max-w-4xl bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden">
        <!-- En-tête avec progression -->
        <div
          class="bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 text-white p-4 sm:p-6"
        >
          <div
          ...
          >
            ...
            <div class="text-right">
              <div class="text-sm text-emerald-200">
                Étape {{ currentStepIndex + 1 }} sur {{ creationSteps.length }}
              </div>
              <div class="text-lg font-bold">
                {{ Math.round(((currentStepIndex + 1) / creationSteps.length) * 100) }}%
              </div>
            </div>
          </div>
          ...
          <div class="flex justify-between mt-4">
            ...
            >
              <div class="relative">
                ...
                <div class="text-[10px] sm:text-xs font-medium truncate px-0.5 sm:px-1">
                  {{ step.title }}
                </div>
                <div
                  v-if="index === currentStepIndex"
                  class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-white rotate-45"
                ></div>
              </div>
            </div>
          </div>
        ...
        <div class="p-4 sm:p-6 md:p-8">
          ...
          <div v-if="currentStepIndex === 1" class="space-y-6">
            ...
            <div
              v-if="step2Form.experiences.length === 0"
            ...
            <div
              v-for="(exp, index) in step2Form.experiences"
              :key="index"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div class="flex items-center mt-2">
                    ...
                    />
                    <label :for="`current-${index}`" class="ml-2 text-sm text-gray-700"
                      >Poste actuel</label
                    >
                  </div>
                </div>
          ...
          <div v-if="currentStepIndex === 2" class="space-y-6">
            ...
            <div
              v-if="step3Form.educations.length === 0"
              class="text-center py-8 border-2 border-dashed border-gray-300 rounded-xl"
            >
              <svg
                class="w-12 h-12 mx-auto text-gray-400 mb-4"
            ...
            <div
              v-for="(edu, index) in step3Form.educations"
              :key="index"
              class="border border-gray-200 rounded-xl p-6 space-y-4"
            >
              <div class="flex justify-between items-start">
          ...
          <div v-if="currentStepIndex === 3" class="space-y-6">
            ...
            <div
              v-if="step4Form.skills.length === 0"
              class="text-center py-8 border-2 border-dashed border-gray-300 rounded-xl"
            >
              <svg
                class="w-12 h-12 mx-auto text-gray-400 mb-4"
            ...
            <div
              v-for="(skill, index) in step4Form.skills"
              :key="index"
    ...
    <div v-if="isLoading" class="min-h-screen bg-gray-50/30 pb-12 mt-10 sm:mt-10 md:mt-10">
      <div
        class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white pt-6 pb-8 sm:pt-8 sm:pb-10 md:py-12"
      >
        <div class="container mx-auto px-3 sm:px-4 md:px-6">
          <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
            <div
              class="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-white/20 rounded-2xl shimmer"
            ></div>
      ...
      <div class="container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 lg:py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-8">
          <div class="lg:col-span-1 space-y-4 sm:space-y-6">
            <div
              class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 shimmer-container"
            >
    ...
    <div
      v-else-if="isProfileComplete && !showCreationWizard"
      class="min-h-screen bg-gray-50/30 pb-12 mt-10 sm:mt-10 md:mt-10"
    >
          ...
          <div class="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            >
              ...
              <div class="relative flex-shrink-0">
                <div
                  class="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm border-2 border-white/30"
                >
                  <div
                    class="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-emerald-500 rounded-xl flex items-center justify-center text-white text-xl sm:text-2xl lg:text-3xl font-bold shadow-lg"
                  >
              ...
              <div class="flex-1 min-w-0">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-2 mb-2">
                  ...
                  <span
                    class="bg-white/20 text-[10px] sm:text-xs px-2 py-0.5 sm:py-1 rounded-full whitespace-nowrap"
                    >Profil complet</span
                  >
                </div>
                ...
                <div
                  class="flex flex-col sm:flex-row flex-wrap items-center sm:items-start justify-center sm:justify-start gap-2 sm:gap-4 text-emerald-100/90 text-sm sm:text-base"
                >
                  ...
                  <div class="flex items-center space-x-1.5 sm:space-x-2">
                    ...
                    <span class="truncate max-w-[150px] sm:max-w-none">{{
                      profile.candidate?.phone || 'Phone not specified'
                    }}</span>
                  </div>
                  <div class="flex items-center space-x-1.5 sm:space-x-2">
                    <svg
                    ...
                    <span class="truncate max-w-[180px] sm:max-w-none">{{
                      profile.candidate?.email || 'Email not specified'
                    }}</span>
                  </div>
                </div>
              </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-8">
          ...
          <div class="lg:col-span-1 space-y-4 sm:space-y-6 order-2 lg:order-1">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 relative group">
              ...
              <div
                class="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-100"
              >
                <div class="text-center">
                  <div class="text-2xl font-bold text-emerald-700 mb-1">
                    {{ profile.salaryExpectationMin || 0 }}€ -
                    {{ profile.salaryExpectationMax || 0 }}€
                  </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 relative group">
              ...
              <div class="flex items-center justify-between mb-4">
                ...
                <span
                  class="bg-emerald-100 text-emerald-700 text-xs font-medium px-2 py-1 rounded-full"
                >
                  {{ skills.length }}
                </span>
              </div>
                  ...
                  <div class="flex-1">
                    <div class="flex items-center justify-between mb-1">
                      ...
                      <span class="text-sm text-emerald-600 font-medium"
                        >{{ skill.experienceYears }} ans</span
                      >
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 relative group">
              ...
              <div class="space-y-6">
                <div
                  ...
                  :key="exp.id"
                  class="relative pl-8 pb-6 border-l-2 border-emerald-200 last:pb-0 group hover:border-emerald-300 transition-colors"
                >
                  <div
                    class="absolute -left-2.5 top-0 w-5 h-5 bg-emerald-500 rounded-full border-4 border-white shadow-lg group-hover:scale-110 transition-transform"
                  ></div>
                  <button
                    @click="openEditSection('experience')"
                  ...
                  <div
                    class="bg-gradient-to-r from-white to-emerald-50/30 p-5 rounded-xl border border-gray-100 hover:border-emerald-200 transition-all duration-300 group-hover:shadow-sm"
                  >
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                      ...
                      <div class="flex items-center space-x-2 mt-1 sm:mt-0">
                        ...
                        >
                          ...
                          {{
                            exp.currentExperienceStatus === 'current'
                              ? 'Présent'
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 relative group">
              ...
              <div class="space-y-6">
                ...
                >
                  ...
                  >
                    <div
                      class="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-1 sm:gap-0"
                    >
                      <h3 class="text-lg font-semibold text-gray-900">
                        {{ edu.degree }} en {{ edu.fieldStudy }}
                      </h3>
                      <div class="flex items-center space-x-2 mt-1 sm:mt-0">
                        <span
                          class="bg-emerald-100 text-emerald-700 text-xs font-medium px-2 py-1 rounded-full"
      ...
      <div
        v-if="showEditModal === 'basics'"
        class="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-2 sm:p-4"
      >
        <div
          class="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden"
        >
          ...
          <div v-else class="p-6 overflow-y-auto max-h-[70vh]">
            <div class="space-y-6">
              ...
              <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                <button
                  @click="showEditModal = null"
                  class="px-6 py-3 border-2 border-gray-300 text-gray-700 hover:bg-gray-50 rounded-xl font-medium transition-all"
                >
                  Annuler
                </button>
                <button
                  @click="saveBasics"
                  :disabled="isSaving"
                  class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium transition-all disabled:opacity-50 flex items-center space-x-2"
                >
      ...
      <!-- Modal: Compétences -->
      <div
        v-if="showEditModal === 'skills'"
        class="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-2 sm:p-4"
      >
        <div
          class="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-3xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden"
        >
          <div class="p-4 sm:p-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
            <div class="flex items-center justify-between">
              <div>
        ...
        >
          ...
          <div v-else class="p-6 overflow-y-auto max-h-[70vh]">
            <div class="space-y-6">
              ...
              <div
                v-for="(exp, index) in editForm.experiences"
                :key="index"
              ...
              >
                  ...
                  <div>
                    ...
                    <div class="flex items-center mt-2">
                      <input
                        ...
                        class="w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500"
                      />
                      <label :for="`edit-current-${index}`" class="ml-2 text-sm text-gray-700"
                        >Poste actuel</label
                      >
                    </div>
                  </div>
                ...
                <div class="flex justify-end">
                  <button
                    @click="removeEditExperience(index)"
          ...
          <div v-else class="p-6 overflow-y-auto max-h-[70vh]">
            <div class="space-y-6">
              ...
              >
                ...
                <div class="flex justify-end">
                  <button
                    @click="removeEditEducation(index)"
                    class="px-3 py-1 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2"
                  >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
...
const validateExperiences = (): boolean => {
  ...
  return step2Form.experiences.every((exp) => exp.jobTitle && exp.companyName && exp.startDate)
}
...
const validateEducations = (): boolean => {
  ...
  return step3Form.educations.every(
    (edu) => edu.institutionName && edu.degree && edu.fieldStudy && edu.startDate && edu.endDate,
  )
}
...
const validateSkills = (): boolean => {
  ...
  return step4Form.skills.every((skill) => skill.skillName && skill.experienceYears > 0)
}
    ...
    for (const skill of existingSkills) {
      ...
      if (
        ...
        (original.skillName !== skill.skillName ||
          original.experienceYears !== skill.experienceYears)
      ) {
