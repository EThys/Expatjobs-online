...
const addCustomSkill = () => {
  if (
    customSkill.value.trim() &&
    !skills.value.find((s) => s.skillName === customSkill.value.trim())
  ) {
    skills.value.push({
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
      ...
      >
        <span class="block"
          >{{ t('postJob.heroTitle') }}
          <span
            class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-teal-400"
            >{{ t('postJob.heroTitleHighlight') }}</span
          ></span
        >
      ...
      <p class="text-xl text-emerald-50 max-w-2xl mx-auto mb-10 animate-fade-in">
        {{ t('postJob.heroDescription') }}
        <strong class="text-white">{{ t('postJob.heroDescriptionHighlight') }}</strong>
        {{ t('postJob.heroDescriptionEnd') }}
      </p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col lg:flex-row gap-8">
                  ...
                  <div class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-1">
                      ...
                      <p class="mt-2 text-sm text-gray-600">
                        {{
                          companies.length === 0
                            ? t('postJob.noCompanyFound')
                            : t('postJob.companiesAvailable', { count: companies.length })
                        }}
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                      ...
                      >
                        ...
                        {{ skill.experienceYear > 1 ? t('postJob.years') : t('postJob.year') }})
                        <button
                          type="button"
                        ...
                        :class="[
                          {
                            ...
                            'bg-gradient-to-r from-emerald-500 to-teal-500 text-white border-2 border-transparent shadow-lg shadow-emerald-500/25':
                              skills.find((s) => s.skillName === skill),
                          },
        ...
        <div class="w-full lg:w-1/3">
          <div
            class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 sticky top-6"
          >
            <div class="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-4">
              <div class="flex items-center">
                <svg
            ...
            <div class="p-6 bg-gradient-to-b from-emerald-50 to-white">
              <div class="text-center mb-6 pb-6 border-b border-gray-200">
                <div
                  class="w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg"
                >
                  <svg
              ...
              <div v-if="skills.length > 0" class="mb-6">
                <h4 class="text-sm font-semibold text-gray-700 mb-3">
                  {{ t('postJob.requiredSkillsPreview') }}
                </h4>
                <div class="flex flex-wrap gap-2">
                  <span
                    v-for="skill in skills"
                  ...
                  >
                    {{ skill.skillName }} ({{ skill.experienceYear }} an{{
                      skill.experienceYear > 1 ? 's' : ''
                    }})
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <div
                  class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm max-h-48 overflow-y-auto"
                >
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between">
                <span
                  :class="[
                    'text-sm font-medium',
                    skills.length > 0 ? 'text-emerald-700' : 'text-gray-500',
                  ]"
                >
                  {{ t('postJob.skills') }}
                </span>
              ...
              <div class="flex items-center justify-between">
                <span
                  :class="[
                    'text-sm font-medium',
                    job.description ? 'text-emerald-700' : 'text-gray-500',
                  ]"
                >
                  {{ t('postJob.description') }}
                </span>
