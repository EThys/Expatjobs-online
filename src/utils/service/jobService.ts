...
export const useJobService = () => {
  ...
  const getAllJobs = async (
    ...
    try {
      const response = await useAxiosRequestWithToken().get(`${ApiRoutes.getAlljobOffers}`, {
        params: {
          page,
          size,
          sort,
  ...
  const getJobById = async (id: number): Promise<IJob> => {
    try {
      const response = await useAxiosRequestWithToken().get(`${ApiRoutes.showjobOffers}/${id}`)
      return response.data
    } catch (error) {
  ...
  const searchJobs = async (
    ...
    try {
      ...
      const response = await useAxiosRequestWithToken().get(`${ApiRoutes.searchJobOffers}/search`, {
        params,
      })
      return response.data
    } catch (error) {
  ...
  const getJobsByCompany = async (
    ...
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des offres de l'entreprise ${companyId}:`,
        error,
      )
      throw error
    }
  ...
  const getJobsBySalaryMax = async (
    ...
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des offres par salaire max ${salaryMax}:`,
        error,
      )
      throw error
    }
  ...
  const getSkillsByJob = async (jobId: number): Promise<ISkillResponse> => {
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des compétences pour l'offre ${jobId}:`,
        error,
      )
      throw error
    }
  ...
  const getAllSkills = async (
    ...
    try {
      const response = await useAxiosRequestWithToken(token).get(`${ApiRoutes.getAlljobSkills}`, {
        params: {
          page,
          size,
          sort,
