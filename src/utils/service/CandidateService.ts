...
export const useCandidateService = () => {
  ...
  const getAuthToken = (): string => {
    ...
    const token =
      (storedToken as any)?.token || (typeof storedToken === 'string' ? storedToken : '')
  ...
  const createCandidateProfile = async (
    profileData: Partial<ICandidateProfile> & { userId?: number },
  ): Promise<ICandidateProfile> => {
    try {
      const token = getAuthToken()
      console.log(
        '🔐 Token utilisé pour createCandidateProfile:',
  ...
  const updateCandidateProfile = async (
    userId: number,
    profileData: Partial<ICandidateProfile>,
  ): Promise<ICandidateProfile> => {
    try {
  ...
  const createCandidateExperience = async (
    experienceData: Omit<ICandidateExperience, 'id'>,
  ...
  const getExperiencesByProfile = async (profileId: number): Promise<ICandidateExperience[]> => {
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des expériences du profil ${profileId}:`,
        error,
      )
      throw error
    }
  ...
  const updateCandidateExperience = async (
    id: number,
    experienceData: Partial<ICandidateExperience>,
  ): Promise<ICandidateExperience> => {
    try {
      const response = await useAxiosRequestWithToken(getAuthToken()).put(
  ...
  const createCandidateEducation = async (
    educationData: Omit<ICandidateEducation, 'id'>,
  ...
  const getEducationsByProfile = async (profileId: number): Promise<ICandidateEducation[]> => {
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des formations du profil ${profileId}:`,
        error,
      )
      throw error
    }
  ...
  const updateCandidateEducation = async (
    id: number,
    educationData: Partial<ICandidateEducation>,
  ): Promise<ICandidateEducation> => {
    try {
      const response = await useAxiosRequestWithToken(getAuthToken()).put(
  ...
  const createCandidateSkill = async (
    skillData: Omit<ICandidateSkill, 'id'>,
  ...
  const getSkillsByProfile = async (profileId: number): Promise<ICandidateSkill[]> => {
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des compétences du profil ${profileId}:`,
        error,
      )
      throw error
    }
  ...
  const createCandidateSkillsBatch = async (
    skillsData: Omit<ICandidateSkill, 'id'>[],
  ): Promise<ICandidateSkill[]> => {
    try {
  ...
  const updateCandidateSkill = async (
    id: number,
    skillData: Partial<ICandidateSkill>,
  ): Promise<ICandidateSkill> => {
    try {
      const response = await useAxiosRequestWithToken(getAuthToken()).put(
  ...
  const getCompleteCandidateData = async (userId: number): Promise<ICandidateData> => {
    try {
      ...
      console.error(
        `❌ Erreur lors de la récupération des données complètes du candidat ${userId}:`,
        error,
      )
      throw error
    }
