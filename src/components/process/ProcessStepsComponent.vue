...
<template>
  <section class="py-20 sm:py-24 bg-white relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      ...
      ></div>
      <div
        class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] bg-emerald-50/50 rounded-full blur-[120px]"
      ></div>
      <div
        class="absolute top-[20%] -right-[10%] w-[40%] h-[40%] bg-green-50/50 rounded-full blur-[100px]"
      ></div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
      ...
      <div class="text-center max-w-3xl mx-auto mb-20 animate-fade-in-up">
        <h2
          class="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight leading-tight"
        >
          {{ t('about.process.title') }}
          <span
            class="transparent-text bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 bg-clip-text text-transparent"
          >
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
        ...
        <div
          class="hidden md:block absolute top-[3.5rem] left-[16%] right-[16%] h-0.5 bg-gradient-to-r from-emerald-100 via-green-100 to-teal-100 z-0"
        ></div>
        ...
        >
          ...
          >
            ...
            <!-- Step Number Badge -->
            <div
              class="absolute top-6 right-6 font-black text-6xl opacity-5 select-none"
            ...
            <div class="relative mb-8 inline-block">
              ...
              <div
                ...
                class="md:hidden absolute -bottom-12 left-1/2 -translate-x-1/2 w-0.5 h-8 bg-gray-100"
              ></div>
            </div>
            ...
            <!-- Features List -->
            <ul class="space-y-3">
              <li v-for="i in 3" :key="i" class="flex items-start gap-3 text-sm text-gray-600">
            ...
            <!-- Bottom Arrow Action -->
            <div
              class="mt-8 pt-6 border-t border-gray-50 flex items-center justify-between group-cursor-pointer"
            >
              <span class="text-sm font-semibold" :class="step.iconColor">{{
                t('common.learnMore')
              }}</span>
              <ArrowRightIcon
